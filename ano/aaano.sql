...
ADD
  PRIMARY KEY (`id`),
ADD
  KEY `id_voluntario_lider` (`id_voluntario_lider`);
...
ALTER TABLE
  `equipes`
ADD
  CONSTRAINT `equipes_ibfk_1` FOREIGN KEY (`id_voluntario_lider`) REFERENCES `voluntarios` (`id`);
